      ...
      <div className=" mt-5 w-full">
        <div className="  pb-4 px-4 rounded-md ">
          <div className="flex justify-between w-full pt-6 ">
            <p className="ml-3 font-semibold"> Main Menu</p>
            <div className="w-full sm:w-64 inline-block relative ">
              <input
                type=""
                name=""
                className="leading-snug border border-gray-300  block w-full appearance-none bg-gray-100 text-sm text-gray-600 py-1 px-4 pl-8 rounded-lg dark:border-gray-700 dark:bg-gray-400 dark:text-gray-700 dark:placeholder:text-gray-600"
                placeholder="Search"
              />

              <div className="pointer-events-none absolute pl-3 inset-y-0 left-0 flex items-center px-2 text-gray-300 dark:text-gray-800">
                <svg
          ...
          <div className="w-full flex justify-end px-2 mt-2"></div>
